...
(function () {
  ...
  var DICT = {
    ...
    "Mit eigenem Bad": { en: "En-suite bathroom", hr: "S vlastitom kupaonicom" },
    "2 Schlafzimmer mit eigenem Bad": { en: "2 bedrooms with en-suite bathroom", hr: "2 spavaće sobe s vlastitom kupaonicom" },
    "Villa & Lage": { en: "Villa & location", hr: "Vila i lokacija" },
    "Küche & Essbereich": { en: "Kitchen & dining", hr: "Kuhinja i blagovaonica" },
    "Schlafen": { en: "Sleeping", hr: "Spavanje" },
    "Pool & Terrasse": { en: "Pool & terrace", hr: "Bazen i terasa" },
    ...
    "Am einfachsten direkt bei uns — per WhatsApp oder über das Formular unten. Direkt ist es am günstigsten: keine Plattformgebühren, persönliche Antwort meist innerhalb weniger Stunden und flexible Absprachen.": { en: "Easiest is directly with us — via WhatsApp or the form below. Booking direct is also the best deal: no platform fees, a personal reply usually within a few hours, and flexible arrangements.", hr: "Najjednostavnije izravno kod nas — putem WhatsAppa ili obrasca u nastavku. Izravno je i najpovoljnije: bez naknada platformi, osoban odgovor obično u roku od nekoliko sati i fleksibilni dogovori." },
    "Haben wirklich alle Zimmer Meerblick?": { en: "Do all rooms really have a sea view?", hr: "Imaju li doista sve sobe pogled na more?" },
    "Ja — die Villa liegt am Hang über der Küste, dadurch blickt jedes Zimmer auf die Kvarner Bucht.": { en: "Yes — the villa sits on the hillside above the coast, so every room looks out over Kvarner Bay.", hr: "Da — vila se nalazi na padini iznad obale, pa svaka soba gleda na Kvarnerski zaljev." },
    "Ist der Pool für alle Gäste da?": { en: "Is the pool available to all guests?", hr: "Je li bazen dostupan svim gostima?" },
    "Ja. Pool, Sonnenterrasse mit Liegen und die Grill-Lounge teilen sich alle Gäste der Villa.": { en: "Yes. The pool, the sun terrace with loungers and the grill lounge are shared by all guests of the villa.", hr: "Da. Bazen, sunčalište s ležaljkama i lounge s roštiljem dijele svi gosti vile." },
    "Können wir die ganze Villa für uns mieten?": { en: "Can we rent the whole villa for ourselves?", hr: "Možemo li unajmiti cijelu vilu samo za sebe?" },
    "Ja — alle drei Apartments zusammen bieten Platz für bis zu 16 Gäste, ideal für Familien und Freundesgruppen. Einfach im Formular „Gesamte Villa“ wählen.": { en: "Yes — all three apartments together sleep up to 16 guests, ideal for families and groups of friends. Just select “Whole villa” in the form.", hr: "Da — sva tri apartmana zajedno primaju do 16 gostiju, idealno za obitelji i grupe prijatelja. Jednostavno u obrascu odaberite „Cijela vila“." },
    "Wann sind Check-in und Check-out?": { en: "When are check-in and check-out?", hr: "Kada su check-in i check-out?" },
    "Check-in 15:00–22:00 Uhr, Check-out bis 10:00 Uhr. Self-Check-in ist möglich, und bei den Zeiten finden wir fast immer eine Lösung.": { en: "Check-in 3–10 pm, check-out by 10 am. Self-check-in is available, and we can almost always find a solution on timing.", hr: "Check-in 15:00–22:00, check-out do 10:00. Moguć je self-check-in, a oko vremena gotovo uvijek nađemo rješenje." },
    "Gibt es Parkplätze am Haus?": { en: "Is there parking at the house?", hr: "Ima li parkirnih mjesta uz kuću?" },
    "Ja, kostenlose Privatparkplätze direkt an der Villa — und eine E-Auto-Ladestation (gegen Aufpreis).": { en: "Yes, free private parking right at the villa — plus an EV charging station (extra charge).", hr: "Da, besplatan privatni parking uz samu vilu — i punionica za električna vozila (uz nadoplatu)." },
    ...
    "Umgebungsfotos via Wikimedia Commons (CC BY / BY-SA): Hotel Kvarner © Bolson75 · Rijeka © Antonio199cro · Mošćenička Draga © Mario Fajt · Učka © Wolfgang Glock · Lovran © Falk2 · Krk © Falk2.": { en: "Surrounding photos via Wikimedia Commons (CC BY / BY-SA): Hotel Kvarner © Bolson75 · Rijeka © Antonio199cro · Mošćenička Draga © Mario Fajt · Učka © Wolfgang Glock · Lovran © Falk2 · Krk © Falk2.", hr: "Fotografije okolice putem Wikimedia Commons (CC BY / BY-SA): Hotel Kvarner © Bolson75 · Rijeka © Antonio199cro · Mošćenička Draga © Mario Fajt · Učka © Wolfgang Glock · Lovran © Falk2 · Krk © Falk2." },
